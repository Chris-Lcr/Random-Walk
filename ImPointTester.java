/**
  ...
  * author: CMB
  *
  * Note: "private static" methods below are how we define helper functions for other static functions.  Need to be static because main is static.  Don't need to be public because they are only ever called by main (not from outside the class).
*/
...
public class ImPointTester {
    ...
    */
    ...
    private static void testTranslate(ImPoint loc, int deltaX, int deltaY) {
        ...
        System.out.println("Old point [expected:(" + oldX + "," + oldY+")]: " + loc + ".");

        System.out.println("New point [expected:("+ (oldX+deltaX) + "," + (oldY+deltaY) + ")]: " + p2 + ".");
