...
class ImPoint {
    ...
    /**
      * Returns an ImPoint with coordinates translated by deltaX and deltaY from this point.
    */
    ...
    /**
       ...
       *In Java toString is a special function.  You are allowed to do a call like the following, and toString will get automatically called to do the conversion:
      *
      * ImPoint myImPoint . . .;
      *. . .
